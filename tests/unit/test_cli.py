...
def strip_ansi(text):
    ...
    This is needed because Rich/Typer may output ANSI color codes in CI
    environments, which would cause string assertions to fail.
    """
...
def test_help_flag(runner):
    ...
    # Strip ANSI codes for reliable assertions across different environments
    clean_output = strip_ansi(result.stdout)
    assert "Create resources on Seqera Platform" in clean_output
